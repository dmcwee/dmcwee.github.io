...
`$get` is a SharePoint provided function which return the HTML DOM object and issimilar to the jQuery $("#" + controlId). I've used only the SharePoint functionality here to prevent confusion with other JS libraries._
